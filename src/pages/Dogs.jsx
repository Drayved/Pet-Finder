...
export default function Dogs(){
    ...
    const dogs = results.filter((animal) => animal.type === "Dog" && animal.photos.length > 0)
    ...
    useEffect(() => {
      const fetchPets = async () => {
        ...
        let endpoint = `https://api.petfinder.com/v2/animals/?limit=20&type=dog`;
